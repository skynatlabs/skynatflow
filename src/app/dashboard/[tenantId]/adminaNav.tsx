  ...
  const groups: TwinNavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: `${d}/power`, label: "Power" },
        { href: `${d}/field`, label: "Field mode" },
        ...
        { href: `${d}/rewards`, label: "Rewards", ...(is("RETAIL") ? {} : q(`${d}/rewards`)) },
        { href: `${d}/credit-book`, label: "Credit Book", ...(is("RETAIL") ? {} : q(`${d}/credit-book`)) },
        { href: `${d}/recipes`, label: "Recipes", ...(is("RETAIL") ? {} : q(`${d}/recipes`)) },
        { href: `${d}/field-sales`, label: "Field Sales", ...(is("WHOLESALE") ? {} : q(`${d}/field-sales`)) },
        { href: `${d}/distribution`, label: "Distribution", ...(is("WHOLESALE") ? {} : q(`${d}/distribution`)) },
        { href: `${d}/roster`, label: "Roster", ...q(`${d}/roster`) },
        { href: `${d}/casual-pay`, label: "Casual Pay", ...q(`${d}/casual-pay`) },
        { href: `${d}/cod`, label: "Cash on Delivery", ...(is("LOGISTICS") ? {} : q(`${d}/cod`)) },
        { href: `${d}/bill-check`, label: "Before You Pay", ...q(`${d}/bill-check`) },
        { href: `${d}/compare`, label: "How You Compare", ...q(`${d}/compare`) },
        { href: `${d}/warehouse`, label: "Warehouse", ...(is("WHOLESALE") ? {} : q(`${d}/warehouse`)) },
        { href: `${d}/authenticity`, label: "Authentication", ...q(`${d}/authenticity`) },
