...
export default async function TenantShellLayout({
  ...
  const nav = [
    ...
    { href: `/dashboard/${tenantId}/agreements`, label: "Proposals & contracts", icon: SignatureIcon },
    ...
    { href: `/dashboard/${tenantId}/payables`, label: "What you owe", icon: QuoteIcon },
    ...
    { href: `/dashboard/${tenantId}/delivery-notes`, label: "Delivery notes", icon: SignatureIcon },
    ...
    { href: `/dashboard/${tenantId}/overdue`, label: "Who to chase", icon: SignatureIcon },
    ...
    { href: `/dashboard/${tenantId}/dispatch`, label: "The week", icon: ColumnsIcon },
    { href: `/dashboard/${tenantId}/power`, label: "Power", icon: ColumnsIcon },
    { href: `/dashboard/${tenantId}/field`, label: "Field mode", icon: ColumnsIcon },
    ...
    { href: `/dashboard/${tenantId}/rewards`, label: "Rewards", icon: UsersIcon },
    { href: `/dashboard/${tenantId}/credit-book`, label: "Credit Book", icon: QuoteIcon },
    { href: `/dashboard/${tenantId}/recipes`, label: "Recipes", icon: BoxIcon },
    { href: `/dashboard/${tenantId}/field-sales`, label: "Field Sales", icon: UsersIcon },
    { href: `/dashboard/${tenantId}/distribution`, label: "Distribution", icon: BoxIcon },
    { href: `/dashboard/${tenantId}/roster`, label: "Roster", icon: UserCogIcon },
    { href: `/dashboard/${tenantId}/casual-pay`, label: "Casual Pay", icon: UserCogIcon },
    { href: `/dashboard/${tenantId}/cod`, label: "Cash on Delivery", icon: QuoteIcon },
    { href: `/dashboard/${tenantId}/bill-check`, label: "Before You Pay", icon: SignatureIcon },
    { href: `/dashboard/${tenantId}/compare`, label: "How You Compare", icon: SignatureIcon },
    { href: `/dashboard/${tenantId}/warehouse`, label: "Warehouse", icon: BoxIcon },
    { href: `/dashboard/${tenantId}/authenticity`, label: "Authentication", icon: SignatureIcon },
    { href: `/dashboard/${tenantId}/staff`, label: "Staff & Roles", icon: UserCogIcon },
    { href: `/dashboard/${tenantId}/payroll`, label: "Payroll", icon: UserCogIcon },
